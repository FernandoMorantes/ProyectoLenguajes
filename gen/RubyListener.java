...
public interface RubyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RubyParser#dynamic}.
	 * @param ctx the parse tree
	 */
	void enterDynamic(RubyParser.DynamicContext ctx);
	/**
	 * Exit a parse tree produced by {@link RubyParser#dynamic}.
	 * @param ctx the parse tree
	 */
	void exitDynamic(RubyParser.DynamicContext ctx);
	/**
